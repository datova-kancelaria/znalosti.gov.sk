package sk.gov.knowledgegraph.views.sparql;
...
@Route(value = "sparql", layout = MainView.class)
...
public class SparqlView extends Div {
    ...
    public SparqlView(@Autowired SparqlAPI sparqlService) throws UnsupportedRDFormatException, FileNotFoundException, IOException, ParserConfigurationException, TransformerException {
        setId("sparql-view");
    ...
    //    input.setType("text");
        ...
        */
        ...
        btnSearch2.addClickListener(e -> {
           ...
           grid5.setItems(sparqlService.search(input.getValue()));
