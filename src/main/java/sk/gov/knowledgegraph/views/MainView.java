...
//    private final Tabs menu;
    ...
    public MainView() {
    	...
    	// Menu
	     ...
	     li2.add(new Html("<a class=\"govuk-link idsk-header-web__nav-list-item-link\" href=\"/metadata\" title=\"Metadáta (CMÚ)\">\n"
	     		+ "                    Metadáta (CMÚ)\n"
	     		+ "                  </a>"));
	    
	     ListItem li3 = new ListItem();
	     li3.addClassName("idsk-header-web__nav-list-item");
	     li3.add(new Html("<a class=\"govuk-link idsk-header-web__nav-list-item-link\" href=\"/data\" title=\"Príklady dát\">\n"
	     		+ "                    Príklady dát\n"
	     		+ "                  </a>"));
	  
	     ListItem li4 = new ListItem();
	     li4.addClassName("idsk-header-web__nav-list-item");
	     li4.add(new Html("<a class=\"govuk-link idsk-header-web__nav-list-item-link\" href=\"/sparqlView\" title=\"SPARQL Endpoint\">\n"
	     		+ "                    SPARQL\n"
	     		+ "                  </a>"));
	 
	     ListItem li5 = new ListItem();
	     li5.addClassName("idsk-header-web__nav-list-item");
	     li5.add(new Html("<a class=\"govuk-link idsk-header-web__nav-list-item-link\" href=\"/api\" title=\"API\">\n"
	     		+ "                    API\n"
	     		+ "                  </a>"));
	 
	     ListItem li6 = new ListItem();
	     li6.addClassName("idsk-header-web__nav-list-item");
	     li6.add(new Html("<a class=\"govuk-link idsk-header-web__nav-list-item-link\" href=\"/about\" title=\"O portáli\">\n"
	     		+ "                    O portáli\n"
	     		+ "                  </a>"));
	  	     
	     
	     ulMenu.add(li1, li2, li3, li4, li5, li6);
