...
import sk.gov.knowledgegraph.views.sparqlView.SparqlView;
...
public class ResourceAPI {
	...
	throws IOException 
	{
		...
		Query preparedQuery = connection.prepareQuery(QueryLanguage.SPARQL, queryString);

		GraphQuery gq = (GraphQuery) preparedQuery;
